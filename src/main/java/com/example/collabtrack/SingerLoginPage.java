...
public class SingerLoginPage {
    ...
    private Singer loggedInSinger; // Store the logged-in singer
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("signup_data.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (fields.length >= 9) {
                    ...
                    Singer singer = new Singer(fields[0], fields[1], fields[2], fields[3], fields[4], fields[5], fields[6], fields[7], fields[8]);
