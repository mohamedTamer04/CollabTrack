...
public class MusicianSignUpPage {
    ...
    private void insertMusician() {
        ...
        // Call insertMusician method of DatabaseHandler
        databaseHandler.insertMusician(name, email, phoneNumber, genre, language, gender, bio, username, password, instrument);
    }
    private boolean validateData() {
        ...
        if (name.isEmpty() || email.isEmpty() || phoneNumber.isEmpty() || genre == null || language == null || bio.isEmpty() || gender == null || username.isEmpty() || password.isEmpty() || instrument.isEmpty()) {
    ...
    private void saveToFile() {
        ...
        String data = name + "-" + email + "-" + phoneNumber + "-" + genre + "-" + language + "-" + gender + "-" + bio + "-" + username + "-" + password + "-" + instrument + "\n";
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("musician_data.txt", true))) {
            writer.write(data);
        } catch (IOException e) {
            e.printStackTrace();
